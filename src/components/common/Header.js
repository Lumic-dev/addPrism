...
const Header = ({ user }) => {
    ...
    return categorys === null || notification === null ? (
        <Loading />
    ) : (
                ...
                <div className="wrap">
                    {user?.result === "ok" ? (
                        <ul className="userNav">
                            ...
                            <li>
                                <Link to={"product/basket"}>장바구니</Link>
                            </li>
                            <li>
                                <Link to={"myPage/order/1"}>마이페이지</Link>
                            </li>
                                                ...
                                                >
                                                    <Link
                                                        to={
                                                            ...
                                                            "message"
                                                                ? `/myPage/contact`
                                                                : `/myPage/orderDetail/${a.orderCode}`
                                                        }
                                                    >
                                                        <p>
                                                            {a.content ===
            ...
            <Head>
                <div className="wrap">
                    <div className="flexBox">
                        <a href="/">
                            <h1 className="logo">LatteRoast</h1>
                        </a>
                        <nav className="pc">
                            <ul>
                                {categorys?.map((a, i) => {
                                    return (
                                        <li key={i}>
                                            <Link
                                                to={`/product/products/${a.cate_code}10/1`}
                                            >
                                                {a.cate}
                                            </Link>
                                            <ol>
                                                {a.lowCategory?.map((b, j) => {
                                                    return (
                                                        <li key={j}>
                                                            <Link
                                                                to={`/product/products/${b.cate_code}/1`}
                                                            >
                                                                {b.cate}
                                                            </Link>
                                                        </li>
                                ...
                                <li>
                                    <Link to={"community/review/all/1"}>
                                        리뷰보기
                                    </Link>
                                </li>
                                <li>
                                    <Link to={"community/notice/1"}>
                                        공지사항
                                    </Link>
                                </li>
                            </ul>
                                        ...
                                        return (
                                            <li key={i}>
                                                {a.lowCategory.length <= 0 ? (
                                                    <Link
                                                        to={`/product/products/${a.cate_code}/1`}
                                                    >
                                                        {a.cate}
                                                    </Link>
                                                ) : (
