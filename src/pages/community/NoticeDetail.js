            ...
            <div className="wrap">
                ...
                <div className="title">
                    ...
                    <div>
                        <p>
                            <b>작성일</b>
                            {readDetail.detail.create_date}
                        </p>
                        <p>
                            <b>조회수</b>
                            {readDetail.detail.view_up}
                        </p>
                    </div>
                </div>
                ...
                <div className="content">
                    <p
                        dangerouslySetInnerHTML={{
                            __html: readDetail.detail.content,
                        }}
                    ></p>
                </div>

                <Link to="/community/notice/1" className="more">
                    목록
                </Link>
                                ...
                                <Link
                                    to={
                                        readDetail.next.length <= 0
                                            ? null
                                            : `/community/noticeDetail/${Number(
                                                  readDetail.next[0].i_board
                                              )}`
                                    }
                                >
                                    {readDetail.next.length <= 0
